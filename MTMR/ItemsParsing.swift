...
@MainActor
final class SupportedTypesHolder {
    private let supportedTypes: [String: ParametersDecoder] = [
        "escape": { _ in (
    ...
    // Note: Changed from singleton to instance to avoid concurrency issues
